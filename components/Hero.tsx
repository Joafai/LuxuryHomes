...
const stats = [
  { num: 200, suffix: "+", label: "Agents Launched" },
  { num: 94, suffix: "%", label: "Client Retention" },
  { num: 3, suffix: "×", label: "Avg. Lead Increase" },
  { num: 48, suffix: "h", label: "First Draft Delivery" },
];
      ...
      <div style={{ position: "absolute", inset: 0 }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(180deg, rgba(10,10,15,0.72) 0%, rgba(10,10,15,0.55) 40%, rgba(10,10,15,0.82) 100%)",
          }}
        />
        {/* Gold radial glow */}
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 70% 50% at 50% 40%, rgba(201,169,110,0.06) 0%, transparent 70%)",
          }}
        />
      </div>
      {/* Subtle grid on top */}
        ...
        >
          <a
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = "0 12px 40px rgba(201,169,110,0.25)";
            }}
            onMouseLeave={(e) => {
